 ...
 *     &lt;enumeration value="AsientoPendienteAgrupaciï¿½n_segregacionFincas"/>
...
public enum ConfigurationTTipoCarga {
    ...
    ASIENTO_PENDIENTE_AGRUPACIÃ’N_SEGREGACION_FINCAS("AsientoPendienteAgrupaci\u00f3n_segregacionFincas"),
